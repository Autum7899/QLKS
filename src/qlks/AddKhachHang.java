 ...
 * @author Admin
 */
public class AddKhachHang extends RoundedFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(close, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 0, 60, 60));
        ...
        jPanel3.add(btnThem, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 360, 100, 40));

        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(25, 0, 500, 420));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 60, 550, 440));
